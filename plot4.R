...
if (exists("household_data")){
        ...
        household_data$Voltage<-as.numeric(as.character(household_data$Voltage))
        household_data$Global_reactive_power<-as.numeric(as.character(household_data$Global_reactive_power))
...
plot(datetime,selected_data$Voltage, type="l",ylab="Voltage")
...
plot(datetime,selected_data$Global_reactive_power, type="l",ylab="global_reactive_power")
dev.off()
